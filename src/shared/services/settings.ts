...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      name: 'studytrace_ai',
      title: 'StudyTrace AI',
      description: 'Custom StudyTrace academic evidence analysis settings',
      tab: 'ai',
    },
    {
      name: 'replicate',
...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    {
      name: 'studytrace_ai_provider',
      title: 'StudyTrace AI Provider',
      type: 'text',
      placeholder: 'evolink',
      value: 'evolink',
      group: 'studytrace_ai',
    ...
    {
      name: 'studytrace_ai_base_url',
      title: 'StudyTrace AI Base URL',
      type: 'url',
    ...
    {
      name: 'studytrace_ai_model',
      title: 'StudyTrace AI Model',
      type: 'text',
    ...
    {
      name: 'studytrace_ai_api_key',
      title: 'StudyTrace AI API Key',
      type: 'password',
      placeholder: 'sk-xxx',
      group: 'studytrace_ai',
      tab: 'ai',
    ...
    {
      name: 'studytrace_analysis_cost_credits',
      title: 'StudyTrace Analysis Cost Credits',
      type: 'number',
      placeholder: '1',
      value: '1',
      group: 'studytrace_ai',
    ...
    {
      name: 'studytrace_analysis_min_interval_ms',
      title: 'StudyTrace Analysis Min Interval (ms)',
      type: 'number',
      placeholder: '5000',
      value: '5000',
      group: 'studytrace_ai',
    ...
    {
      name: 'studytrace_ingest_cost_credits',
      title: 'StudyTrace Ingest Cost Credits',
      type: 'number',
      placeholder: '1',
      value: '1',
      group: 'studytrace_ai',
    ...
    {
      name: 'studytrace_ingest_min_interval_ms',
      title: 'StudyTrace Ingest Min Interval (ms)',
      type: 'number',
      placeholder: '5000',
      value: '5000',
      group: 'studytrace_ai',
